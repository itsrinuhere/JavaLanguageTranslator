...
public class Tick {
    ...
    int run() {
        ...
        do {
            ...
            System.out.println("Player " + player + ", enter a number from 1 to 9:  ");
            choice = sc.nextInt();
    ...
    /*****
     * FUNCTION TO RETURN GAME STATUS 1 FOR GAME IS OVER WITH RESULT -1 FOR GAME IS
     * IN PROGRESS O GAME IS OVER AND NO RESULT
     ******/
